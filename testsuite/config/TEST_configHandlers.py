...
# - prolog marker
from testFwk import create_config, function_factory, remove_files_testsuite, run_test, try_catch
...
class Test_ConfigValidator:
	"""
	>>> remove_files_testsuite(['work.conf'])
...
def test_cin(test_fun, answer_fun):
	...
	utils.get_user_bool.ask_user_fun = answer_fun
...
run_test(exit_fun = lambda: remove_files_testsuite(['work.conf']))
