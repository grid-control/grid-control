...
# - prolog marker
import os
from testFwk import create_config, run_test, setPath, str_dict_testsuite
...
def test_discover(plugin, src = '/dev/null', wmsIDs = None, **kwargs):
...
class Test_GridEngine:
	"""
	>>> test_discover('GridEngine_Discover_Queues')
	...
	>>> test_discover('GridEngine_Discover_Nodes')
	{'name': '@12core'}
	{'name': '@1week'}
	{'name': '@24core'}
	{'name': '@48core'}
...
class Test_PBS:
	"""
	>>> test_discover('PBS_Discover_Queues', src = 'test.PBS.queues')
	...
	>>> test_discover('PBS_Discover_Nodes')
	{'name': 'ekpplus010'}
	{'name': 'ekpplus012'}
	{'name': 'ekpplus013'}
	{'name': 'ekpplus015'}
